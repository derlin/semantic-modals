        ...
        function getTemplate( options ){
            ...
            if( !options.templateUrl ){
                ...
                if( options.basic ){
                    ...
                    //html = '<div class="ui basic modal"> <i class="close icon" ng-click="close(false)"></i> <div class="header">{{title}}</div> <div class="image content"> <div class="description"> <p ng-show="text">{{text}}</p> ' + content + ' </div> </div> <div class="actions"> <div class="ui inverted buttons"> <div class="ui red basic inverted button" ng-click="close(false)" ng-show="negative"> <i class="remove icon"></i> {{negative}} </div> <div class="ui green basic inverted button" ng-click="close(true)" ng-show="positive"> <i class="checkmark icon"></i> {{positive}} </div>' +' </div> </div> </div>';
